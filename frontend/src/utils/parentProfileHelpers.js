...
export const buildParentDisplayData = (row) => {
  ...
  return {
    ...
    preferred_parent_mobile: pick('preferred_parent_mobile', 'preferred_mobile', 'Preferred Parent Mobile', 'Preferred Mobile'),
    father_name: pick('father_name', 'Father Name'),
    mother_name: pick('mother_name', 'Mother Name'),
